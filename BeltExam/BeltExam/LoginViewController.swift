...
class LoginViewController: UIViewController {
    ...
    @IBAction func loinButton(_ sender: UIButton) {
        ...
        //delet this if any error
        let nextVC = self.storyboard?.instantiateViewController(withIdentifier: "GroceryViewController") as? GroceryViewController
    ...
    private func loginUser() {
        ...
        FireUser.shared.loginUserWith(email: emailTextField.text!, pasword: passwordTextField.text!) { (error, isEmailVerified) in
            ...
            if error != nil {
                if isEmailVerified {
                    ...
                    let alert =  UIAlertController()
                    let action = UIAlertAction(title: " chack your email ", style: .default, handler: nil)
                    alert.addAction(action)
                    self.present(alert, animated: true, completion: nil)
                }
...
//            }else{
//                let alert =  UIAlertController()
//                let action = UIAlertAction(title: " you login  ", style: .default, handler: nil)
//                alert.addAction(action)
//                self.present(alert, animated: true, completion: nil)
    ...
    private func goToNextView() {
        ...
        let mine = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "main") as! GroceryViewController
